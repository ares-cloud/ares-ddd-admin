...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.RuntimeMetricsDto"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.OperationLogDto"
                                            }
                                        }
                                    }
                                }
        ...
        "/v1/storage/files": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "存储类型(minio/aliyun/tencent),默认为minio",
                        "name": "storage_type",
                        "in": "formData"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.BatchDeleteFilesCommand"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.BatchMoveFilesCommand"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.ShareFileCommand"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.FileShareDto"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.CreateFolderCommand"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/sys/login-log/admin": {
            "get": {
                ...
                "summary": "查询管理端登录日志列表",
                "operationId": "ListAdminLoginLogs",
                "parameters": [
                    {
                        "type": "string",
                        "description": "查询月份(格式:202403)",
                        "name": "month",
                        "in": "query",
                        "required": true
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.UpdatePermissionsCommand"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.CreatePermissionsCommand"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/sys/permissions/enabled": {
            "get": {
                ...
                "summary": "获取所有启用状态的权限",
                "operationId": "GetAllEnabledPermissions",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
        ...
        "/v1/sys/permissions/simple/tree": {
            "get": {
                ...
                "summary": "获取简化的权限树结构",
                "operationId": "GetPermissionsSimpleTree",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.PermissionsTreeResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/v1/sys/permissions/tree": {
            "get": {
                ...
                "summary": "获取权限树",
                "operationId": "GetPermissionsTree",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "权限类型",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.UpdateRoleCommand"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.CreateRoleCommand"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/sys/role/enabled": {
            "get": {
                ...
                "summary": "获取所有启用状态的角色",
                "operationId": "GetAllEnabledRoles",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.PageRes-dto_TenantDto"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.UpdateTenantCommand"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.CreateTenantCommand"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/sys/tenant/permissions": {
            "put": {
                ...
                "summary": "分配权限给租户",
                "operationId": "AssignTenantPermissions",
                "parameters": [
                    {
                        "description": "权限分配信息",
                        "name": "req",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.AssignTenantPermissionsCommand"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.PermissionsTreeDto"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commands.UpdateUserStatusCommand"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "commands.CreatePermissionsCommand": {
            "type": "object",
            "required": [
                "code",
                "name",
            ...
            "properties": {
                ...
                "resources": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/commands.CreatePermissionsResourceCommand"
                    }
                },
                "sequence": {
                    "type": "integer"
        ...
        "commands.CreatePermissionsResourceCommand": {
            "type": "object",
            "required": [
                "method",
                "path"
        ...
        "commands.LoginType": {
            ...
            "x-enum-comments": {
                "LoginTypeAdmin": "管理端登录",
                "LoginTypeMember": "前台用户登录"
            },
            "x-enum-varnames": [
                "LoginTypeAdmin",
                "LoginTypeMember"
        ...
        "commands.UpdatePermissionsCommand": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "dto.PermissionsDto": {
            ...
            "properties": {
                ...
                "resources": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PermissionsResourceDto"
                    }
                },
                "sequence": {
                    "description": "排序",
        ...
        "dto.RuntimeMetricsDto": {
            ...
            "properties": {
                "gc_cpu_fraction": {
                    "description": "GC占用CPU时间比例",
                    "type": "number"
                },
                "gc_pause_ns": {
                    "description": "最后一次GC暂停时间(纳秒)",
                    "type": "integer"
                },
                "goroutines": {
                ...
                "mcache_in_use": {
                    "description": "正在使用的MCache内存",
                    "type": "integer"
                },
                "mcache_sys": {
                    "description": "系统预留MCache内存",
                    "type": "integer"
                },
                "mspan_in_use": {
                    "description": "正在使用的MSpan内存",
                    "type": "integer"
                },
                "mspan_sys": {
                    "description": "系统预留MSpan内存",
                    "type": "integer"
                },
                "num_gc": {
                    "description": "GC次数",
