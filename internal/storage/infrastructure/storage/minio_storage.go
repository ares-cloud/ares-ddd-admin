...
// Move 移动文件
func (s *MinioStorage) Move(ctx context.Context, file *model.File, toPath string) error {
	// 1. 检查源文件是否存在
	_, err := s.client.StatObject(ctx, s.bucket, file.Path, minio.StatObjectOptions{})
	if err != nil {
