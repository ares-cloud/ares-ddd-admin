...
type UserQueryService interface {
	...
	FindUsers(ctx context.Context, qb *db_query.QueryBuilder) ([]*model.User, error)
	...
	// 部门相关查询
	FindUsersByDepartment(ctx context.Context, deptID string, excludeAdminID string, qb *db_query.QueryBuilder) ([]*model.User, error)
	CountUsersByDepartment(ctx context.Context, deptID string, excludeAdminID string, qb *db_query.QueryBuilder) (int64, error)
	FindUnassignedUsers(ctx context.Context, qb *db_query.QueryBuilder) ([]*model.User, error)
